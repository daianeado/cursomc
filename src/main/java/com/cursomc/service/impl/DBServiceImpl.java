...
public class DBServiceImpl implements DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "dai.daianeaparecidaoliveira@gmail.com", "36378912377",
				TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "dai.daianeoliveira@hotmail.com", "31628382740",
				TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "1237012", cli2, c2);
